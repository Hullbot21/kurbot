...
petik = '```'
fake = 'CREATOR BOT\©Arif'//GANTI NAMA KAMU BEP
ban =[]
...
©𝑪𝒓𝒆𝒂𝒕𝒐𝒓 ©kurrtod`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '\`\`\`SC INI TIDAK DIPERJUAL BELIKAN\`\`\`', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
"caption": "https://chat.whatsapp.com/KMi39dMimZtFJVhPlYb4fh",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
